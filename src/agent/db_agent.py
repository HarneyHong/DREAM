...
class DBAgent:
    def __init__(self, memory_path: str = "memory.db", max_attempts: int = 3):
    ...
    async def diagnose_and_repair(self, 
        ...
        query = QueryInfo(
            ...
            query_plan=convert_plan_to_dict(query_info['query_plan']),
        ...
        while attempts < self.max_attempts and not is_resolved:
            ...
            logger.info(f"第 {attempts} 次分析结果: {analysis_result}")
